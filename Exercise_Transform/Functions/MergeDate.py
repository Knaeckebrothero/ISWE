...
table = [line.replace("ï»¿", "").strip().split(';')
         for line in file_lines]  # --- .replace(" ", "")
...
data_frame_1['month'] = data_frame_1['month'].replace(
    [
        ' January ',
        ' February ',
        ' March ',
...
# the to.datetime function is used to convert the year, month, and day
# data into a date format
